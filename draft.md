...
- exploitable par les LLM (Claude Code, Cursor),
...
Contient les exigences fonctionnelles, non fonctionnelles et contraintes du système.
...
## 📄 README.md — Gouvernance du EKR
Ce fichier doit contenir :
- les règles de contribution  
- les conventions de nommage  
- les règles de placement des fichiers  
- les responsabilités (architecte, dev, PO)  
- les liens vers BMAD et Claude Code

---

# 🧭 Règles de gouvernance (à inclure dans README.md)
...
- la **structure finale**  
- le **mapping BMAD**  
- le **mapping Claude Code**  
- les **règles de gouvernance**  
- un **README prêt pour GitHub**  

C’est un **Engineering Knowledge Repository moderne**, parfaitement aligné avec ton projet multi‑services et les assistants IA.
...
- le **README complet**  
- les **premiers fichiers REQ, ADR, architecture**  
- la **configuration BMAD**  
- les **skills Claude Code**  
- ou même **le Case Service complet** basé sur ton EKR.
